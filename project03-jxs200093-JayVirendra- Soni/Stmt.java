        ...
        switch (cond){
            case 1:
                ...
                if (!stmtType.equals(VarType.Bool) && !stmtType.equals(VarType.Int)) {
                    System.out.println(" Error: Incompatible types: " + stmtType + " cannot be converted to Boolean");
                    System.exit(0);
                }
            ...
            case 3:
                ...
                if (!nameType.equals(expr.typeCheck())) {
                    System.out.println(" Error: Incompatible types: " + expr.typeCheck() + " cannot be casted to " + nameType);
                    System.exit(0);
                }
                var = symbolTable.findVar(name.ID);
                if (var.isFinal) {
                    System.out.println(" Error: Cannot reassign a value to final variable " + name.ID);
                    System.exit(0);
                }
                break;
            case 4:
            ...
            case 7:
                ...
                if (var == null || !var.isMethod ) {
                    System.out.println(" Error: No method found by the name of " + ID);
                    System.exit(0);
                }
                break;
            case 8:
            ...
            case 11:
                if (!name.typeCheck().equals(VarType.Int)){
                    System.out.println(" Error: bad operand type " + name.typeCheck() + " for unary operator " + unaryOperator);
                    System.exit(0);
                }
                return VarType.Int;
            case 12:
