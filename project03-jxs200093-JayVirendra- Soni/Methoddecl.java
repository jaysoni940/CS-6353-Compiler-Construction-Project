...
//        String ret = "";
    ...
    public void typeCheck() throws Exception {
        ...
        if (!symbolTable.addVar(methodName, methodType, true, null)){
            System.out.println(" Error: Function " + methodName + " is already defined in this scope!");
            System.exit(0);
        }
    ...
    private void typeCheckMethod(VarType methodType) throws Exception {
        ...
        if (!methodType.equals(VarType.Void) && !CurrentFunction.containsRet){
            System.out.println(" Error: Missing return statement from function " + methodName);
            System.exit(0);
        }

        if (!isCoercible(methodType, getReturnType())){
            System.out.println(" Error: Incompatible types: " + getReturnType() + " doesn't match expected return type " + methodType);
            System.exit(0);
        }
