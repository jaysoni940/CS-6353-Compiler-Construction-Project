        ...
        switch (cond){
            ...
            case 2:
                ...
                if (fn == null || !fn.isMethod) {
                    System.out.println(" Error: No method found by the name of " + fnName);
                    System.exit(0);
                }
                return fn.type;
            case 3:
            ...
            case 10:
                ...
                if (prefixOperator.equals("~")){
                    if (!isCoercible(VarType.Bool, exprType)){
                        System.out.println(" Error: " + prefixOperator + " is incompatible with variables of type " + exprType);
                        System.exit(0);
                    }
                }else {
            ...
            case 13:
                ...
                if (!conditionalType.equals(VarType.Bool) && !conditionalType.equals(VarType.Int)){
                    System.out.println(" Error: Incompatible types: " + conditionalType + " cannot be converted to Boolean");
                    System.exit(0);
                }
                if (!expr1Type.equals(expr2Type)){
                    System.out.println(" Error: Incompatible types: expr1 type " + expr1Type + " doesn't match expr2 type " + expr2Type);
                    System.exit(0);
                }
                return expr1Type;
            default:
